...
contract OneSplitAudit is IOneSplit, Ownable {
    ...
    IFreeFromUpTo public constant chi = IFreeFromUpTo(0xB99DEa3ca0d2429271D8687Fd335CEfE91F3893D);
    ...
    function _chiBurnOrSell(address payable sponsor, uint256 amount) internal {
        IUniswapV2Exchange exchange = IUniswapV2Exchange(0xcbAD24Ea0e3625b0e5959598d4333B50d348C585);
