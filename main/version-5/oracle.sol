...
contract DAAORacle is Initializable, usingProvable {
    ...
    /**
     * @dev Called by the Provable contracts to return the data of the request. Only provable contract can call this function.
     */
