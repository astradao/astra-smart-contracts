...
contract Swap is Ownable {
    ...
    function initialize(
        ...
        address _univ3Address,
        address _quoterAddress
    ) public initializer {
        Ownable.init(_owner);

        sushiswapRouter = IUniswapV2Router(_sushiAddress);
        uniswapRouterV2 = IUniswapV2Router(_univ2Address);
        uniswapRouterV3 = IUniswapV3Router(_univ3Address);
    ...
    function getPairRateUniV3(
        ...
        if (pairAddress == address(0)) {
            ...
            uint256 _tokenInSwapAmount = getReserveV3(
                pairAddress,
                IERC20(path[0])
            );
