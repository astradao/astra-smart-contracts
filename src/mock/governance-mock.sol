...
contract GovernorAlphaMock is Initializable {
    ...
    function votingPeriod() public pure returns (uint) { return 150; } // ~7 days in blocks (assuming 15s blocks)
    ...
    function initialize(address timelock_, address ASTR_,address _chef) external initializer {
        ...
        quorumVote = 40e18;
        minVoterCount = 1;
        minProposalTimeIntervalSec = 300 seconds;
        proposalTokens = 500 * 10**18;
        stakeVault = 6 ;
        totalTarget = 3;
    }
    /**
