...
/**
 * @title AstraDAOVesting
 */
contract AstraDAOVesting is
    Initializable,
    ...
    KeeperCompatibleInterface
{
        ...
        returns (bytes32)
    {
        require(
            ...
            "AstraDAOVesting: index out of bounds"
        );
    ...
    function addUserDetails(
        ...
        require(_to.length == _amount.length && _to.length == _released.length, "Invalid data");
    ...
    function createVestingSchedule(
        ...
        require(
            ...
            "AstraDAOVesting: cannot create vesting schedule because not sufficient tokens"
        );
        require(_duration > 0, "AstraDAOVesting: duration must be > 0");
        require(_amount > 0, "AstraDAOVesting: amount must be > 0");
        require(_amount >= _released, "AstraDAOVesting: amount must be >= released");
        require(
            _slicePeriodSeconds >= 1,
            "AstraDAOVesting: slicePeriodSeconds must be >= 1"
        );
        ...
        vestingSchedulesTotalAmount = vestingSchedulesTotalAmount.add(_amount).sub(_released);
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        require(
            ...
            "AstraDAOVesting: vesting is not revocable"
        );
    ...
    function withdraw(uint256 amount) external nonReentrant onlyOwner {
        require(
            ...
            "AstraDAOVesting: not enough withdrawable funds"
        );
    ...
    function _release(bytes32 vestingScheduleId, uint256 amount) internal {
        ...
        require(
            vestedAmount >= amount,
            "AstraDAOVesting: cannot release tokens, not enough vested tokens"
        );
