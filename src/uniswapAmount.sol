...
contract UniswapV3PositionUtility is Ownable {
    ...
    function setAstraContract(address _astraContract) external onlyOwner {
        require(_astraContract != address(0), "Zero address");
        astraContract = _astraContract;
    }
    ...
    function getAstraAmount(uint256 tokenID) public view returns (uint256) {
        int24 tickUpper;
        int24 tickLower;
        uint128 liquidity;
        address token0;
